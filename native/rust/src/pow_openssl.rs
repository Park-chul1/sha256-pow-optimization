...
pub fn run_openssl_search(prefix: &[u8], k: u32, double_hash: bool) -> SearchResult {
    run_openssl_search_with_progress(prefix, k, double_hash, None)
}

pub fn run_openssl_search_with_progress(
    prefix: &[u8],
    k: u32,
    double_hash: bool,
